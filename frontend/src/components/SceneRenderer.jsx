  ...
  return (
    <div className="scene-container">
      ...
      <div className="scene-header">
        ...
        {currentScene.location && <div className="scene-location">{currentScene.location}</div>}
      </div>

      {/* Descrição/Narrativa da cena */}
      <div className="scene-content">
        <p className="narrative-text">{currentScene.text}</p>
              ...
              width: `${Math.max(
                ...
                Math.min(
                  ...
                  ((gameState.choices_made?.length || 0) /
                    Math.max(1, Object.keys(scenarioNarrative.scenes || {}).length)) *
                    100
                )
              )}%`,
            }}
